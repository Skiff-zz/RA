...
class Controller_Client_Work_Order extends AC_Controller
{
	protected $model_name = 'client_work_order';
...
//    }
	...
	public function action_edit($id = null, $read = false, $parent_id = false){
        ...
        $view->statuses = array(
        	array( '_id' => 1, 'name' => 'Выдан', 'color' => 'FF0000'),
        	array( '_id' => 2, 'name' => 'Закрыт', 'color' => '00FF00')
        );
