...
class Model_Glossary_DeploymentType extends Model_Glossary_Abstract
{
	public static function initialize(Jelly_Meta $meta, $table_name = 'glossary_deploymenttype', $group_model = NULL)
	{
