...
class Model_Glossary_Abstract extends Jelly_Model
{

	public static function initialize(Jelly_Meta $meta, $table_name  = '__abstract', $group_model = '__abstract_group' )
	{
		/**
         *
         *
		...
		$meta->table($table_name)
			->fields(array(
				...
				'name'			=> Jelly::field('String', array('label' => 'Название','rules'=>array('max_length'=>array(1000))   )),
