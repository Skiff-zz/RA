...
class Model_Client_Work_PlannedOrder2Field extends Jelly_Model
{

    
    public static function initialize(Jelly_Meta $meta)
	{
		$meta->table('work_plannedorder2field')
			->fields(array(
				...
				'materials' => Jelly::field('HasMany',array(
                    'foreign'	=> 'client_work_plannedorderfield2material',
                    'label'	=> 'Материалы',
                )),
                ...
                'personal' => Jelly::field('HasMany',array(
                    'foreign'	=> 'client_work_plannedorderfield2personal',
                    'label'	=> 'Персонал',
                ))
		));
	}
