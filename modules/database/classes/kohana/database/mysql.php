...
class Kohana_Database_MySQL extends Database {
	...
	public function connect()
	{
		...
		try
		{
			$connection = Kohana::config('database.default.connection');
			if ($persistent)
			{
				// Create a persistent connection
				$this->_connection = mysql_pconnect($connection['hostname'], $connection['username'], $connection['password']);
			}
			else
			{
				// Create a connection and force it to be a new link
				$this->_connection = mysql_connect($connection['hostname'], $connection['username'], $connection['password'], TRUE);
			}
		}
